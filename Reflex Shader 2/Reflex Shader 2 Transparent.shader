...
Shader "Reflex Shader 2/Reflex Shader 2 Transparent"
{
	...
	SubShader
	{
		...
		CGPROGRAM
		#pragma target 3.0
		#pragma surface outlineSurf Outline nofog alpha:fade  alpha:auto noshadow noambient novertexlights nolightmap nodynlightmap nodirlightmap nometa noforwardadd vertex:outlineVertexDataFunc 
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float3 hsvTorgb595_g79 = RGBToHSV( lerp(DiffuseBase606_g79,temp_cast_1,_GrayscaleColor).rgb );
			float3 hsvTorgb603_g79 = HSVToRGB( float3(( hsvTorgb595_g79.x + _H ),( hsvTorgb595_g79.y + _S ),( hsvTorgb595_g79.z + _V )) );
			float4 Diffuse105_g79 = lerp(DiffuseBase606_g79,float4( hsvTorgb603_g79 , 0.0 ),_ColorShift);
			...
			float4 clampResult650_g79 = clamp( ( float4( localFunction_ShadeSH9411_g79 , 0.0 ) + ifLocalVar196_g79 ) , temp_cast_6 , float4( 1,1,1,0 ) );
			float4 temp_cast_7 = (1.0).xxxx;
			#ifdef _UNLIT_ON
				float4 staticSwitch647_g79 = temp_cast_7;
			#else
				float4 staticSwitch647_g79 = saturate( clampResult650_g79 );
			#endif
			float4 Lighting201_g79 = staticSwitch647_g79;
			...
			float4 transform434_g79 = mul(unity_ObjectToWorld,float4( _VDirLight , 0.0 ));
			float dotResult441_g79 = dot( transform434_g79 , float4( newWorldNormal334_g79 , 0.0 ) );
			...
			if( ase_lightColor.a <= 0.0 )
				...
				ifLocalVar431_g79 = lerp(lerp(temp_output_335_0_g79,saturate( ( temp_output_335_0_g79 * 1 ) ),_ObjectShadow),( ( saturate( 	max( blendOpSrc566_g79, blendOpDest566_g79 ) )) * lerp(temp_output_335_0_g79,saturate( ( temp_output_335_0_g79 * 1 ) ),_ObjectShadow) ),_LightIntensityShadowPos);
			...
			#ifdef _UNLIT_ON
				float staticSwitch645_g79 = FixedShadow627_g79;
			#else
				float staticSwitch645_g79 = ifLocalVar431_g79;
			#endif
			float temp_output_351_0_g79 = ( ( ( ( _Shadow1Place + staticSwitch645_g79 ) - 0.5 ) * _Shadow1Contrast ) + 0.5 );
			float4 temp_cast_15 = (temp_output_351_0_g79).xxxx;
			float div354_g79=256.0/float((int)255.0);
			float4 posterize354_g79 = ( floor( temp_cast_15 * div354_g79 ) / div354_g79 );
			float4 temp_cast_16 = (temp_output_351_0_g79).xxxx;
			float4 ifLocalVar358_g79 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar358_g79 = posterize354_g79;
			else
				ifLocalVar358_g79 = temp_cast_16;
			float4 temp_cast_17 = (0.0).xxxx;
			float4 temp_cast_18 = (1.0).xxxx;
			float4 clampResult364_g79 = clamp( ifLocalVar358_g79 , temp_cast_17 , temp_cast_18 );
			float4 lerpResult366_g79 = lerp( _Shadow1Color , float4( 1,1,1,0 ) , clampResult364_g79);
			float temp_output_353_0_g79 = ( ( ( ( _Shadow2Place + staticSwitch645_g79 ) - 0.5 ) * lerp(_Shadow1Contrast,_Shadow2Contrast,_Shadow2ContrastToggle) ) + 0.5 );
			float4 temp_cast_20 = (temp_output_353_0_g79).xxxx;
			float div356_g79=256.0/float((int)255.0);
			float4 posterize356_g79 = ( floor( temp_cast_20 * div356_g79 ) / div356_g79 );
			float4 temp_cast_21 = (temp_output_353_0_g79).xxxx;
			float4 ifLocalVar360_g79 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar360_g79 = posterize356_g79;
			else
				ifLocalVar360_g79 = temp_cast_21;
			float4 temp_cast_22 = (0.0).xxxx;
			float4 temp_cast_23 = (1.0).xxxx;
			float4 clampResult363_g79 = clamp( ifLocalVar360_g79 , temp_cast_22 , temp_cast_23 );
			float4 lerpResult368_g79 = lerp( lerp(_Shadow2Color,( saturate( min( blendOpSrc365_g79 , blendOpDest365_g79 ) )),_ShadowColorDarken) , lerpResult366_g79 , clampResult363_g79);
			...
			float4 Shadow375_g79 = lerp(temp_cast_8,lerpResult372_g79,_HalfLambertToggle);
			o.Emission = ( float4( ( (Diffuse105_g79).rgb * appendResult387_g79 ) , 0.0 ) * Lighting201_g79 * Shadow375_g79 ).rgb;
			o.Alpha = lerp(0.0,(Diffuse105_g79).a,_OutlineToggle);
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult230_g79 = lerp( ( ( ( ( ( abs( ( 1.0 - dotResult214_g79 ) ) * _RimLightPower ) - 0.5 ) * _RimLightContrast ) + 0.5 ) * ( _RimLightColor * tex2D( _RimLightColorSampler, uv_RimLightColorSampler ) ) ) , float4( 0,0,0,0 ) , ( 1.0 - tex2D( _RimLightMask, uv_RimLightMask225_g79 ) ));
			float4 RimLight233_g79 = saturate( lerp(float4( 0,0,0,0 ),lerpResult230_g79,_RimLightToggle) );
			float3 NormalMap208_g79 = tex2DNode207_g79;
			...
			float2 temp_output_244_0_g79 = ( 0.5 + ( 0.5 * lerp((temp_output_240_0_g79).xy,(BlendNormals( ( worldToViewDir556_g79 * float3(-1,-1,1) ) , temp_output_240_0_g79 )).xy,_MatcapCameraFix) ) );
			...
			float3 hsvTorgb595_g79 = RGBToHSV( lerp(DiffuseBase606_g79,temp_cast_6,_GrayscaleColor).rgb );
			float3 hsvTorgb603_g79 = HSVToRGB( float3(( hsvTorgb595_g79.x + _H ),( hsvTorgb595_g79.y + _S ),( hsvTorgb595_g79.z + _V )) );
			float4 Diffuse105_g79 = lerp(DiffuseBase606_g79,float4( hsvTorgb603_g79 , 0.0 ),_ColorShift);
			float4 lerpResult252_g79 = lerp( Diffuse105_g79 , float4( 0,0,0,0 ) , tex2DNode246_g79);
			float4 Matcap260_g79 = ( lerp(float4( 0,0,0,0 ),lerpResult254_g79,_MatcapToggle) + lerp(Diffuse105_g79,lerpResult252_g79,_ForceMatcap) );
			...
			float2 uv_ReflectionMask268_g79 = i.uv_texcoord;
			float4 lerpResult273_g79 = lerp( float4( 0,0,0,0 ) , ( float4( indirectSpecular281_g79 , 0.0 ) * _ReflectionColor ) , tex2D( _ReflectionMask, uv_ReflectionMask268_g79 ));
			float4 lerpResult277_g79 = lerp( float4( 0,0,0,0 ) , lerpResult273_g79 , _ReflectionIntensity);
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float fresnelNdotV275_g79 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode275_g79 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV275_g79, _FresnelPower ) );
			float4 lerpResult278_g79 = lerp( float4( 0,0,0,0 ) , lerpResult277_g79 , lerp(1.0,fresnelNode275_g79,_FresnelToggle));
			#ifdef _REFLECTIONTOGGLE_ON
				float4 staticSwitch549_g79 = lerpResult278_g79;
			#else
				float4 staticSwitch549_g79 = float4( 0,0,0,0 );
			#endif
			float4 Reflection280_g79 = staticSwitch549_g79;
			float4 blendOpSrc259_g79 = lerp(float4( 1,1,1,1 ),tex2D( _MatcapShadow, temp_output_244_0_g79 ),_MatcapShadowToggle);
			...
			float4 clampResult650_g79 = clamp( ( float4( localFunction_ShadeSH9411_g79 , 0.0 ) + ifLocalVar196_g79 ) , temp_cast_11 , float4( 1,1,1,0 ) );
			float4 temp_cast_12 = (1.0).xxxx;
			#ifdef _UNLIT_ON
				float4 staticSwitch647_g79 = temp_cast_12;
			#else
				float4 staticSwitch647_g79 = saturate( clampResult650_g79 );
			#endif
			float4 Lighting201_g79 = staticSwitch647_g79;
			...
			if( ase_lightColor.a <= 0.0 )
				...
				ifLocalVar431_g79 = lerp(lerp(temp_output_335_0_g79,saturate( ( temp_output_335_0_g79 * ase_lightAtten ) ),_ObjectShadow),( ( saturate( 	max( blendOpSrc566_g79, blendOpDest566_g79 ) )) * lerp(temp_output_335_0_g79,saturate( ( temp_output_335_0_g79 * ase_lightAtten ) ),_ObjectShadow) ),_LightIntensityShadowPos);
			float3 VDirLight648_g79 = _VDirLight;
			float4 transform617_g79 = mul(unity_ObjectToWorld,float4( VDirLight648_g79 , 0.0 ));
			float3 lerpResult624_g79 = lerp( float3( 0,0,1 ) , NormalMap208_g79 , _NormalIntensity);
			float dotResult613_g79 = dot( transform617_g79 , float4( (WorldNormalVector( i , lerpResult624_g79 )) , 0.0 ) );
			...
			#endif
			float temp_output_351_0_g79 = ( ( ( ( _Shadow1Place + staticSwitch645_g79 ) - 0.5 ) * _Shadow1Contrast ) + 0.5 );
			float4 temp_cast_20 = (temp_output_351_0_g79).xxxx;
			float div354_g79=256.0/float((int)255.0);
			float4 posterize354_g79 = ( floor( temp_cast_20 * div354_g79 ) / div354_g79 );
			float4 temp_cast_21 = (temp_output_351_0_g79).xxxx;
			float4 ifLocalVar358_g79 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar358_g79 = posterize354_g79;
			else
				ifLocalVar358_g79 = temp_cast_21;
			float4 temp_cast_22 = (0.0).xxxx;
			float4 temp_cast_23 = (1.0).xxxx;
			float4 clampResult364_g79 = clamp( ifLocalVar358_g79 , temp_cast_22 , temp_cast_23 );
			float4 lerpResult366_g79 = lerp( _Shadow1Color , float4( 1,1,1,0 ) , clampResult364_g79);
			float temp_output_353_0_g79 = ( ( ( ( _Shadow2Place + staticSwitch645_g79 ) - 0.5 ) * lerp(_Shadow1Contrast,_Shadow2Contrast,_Shadow2ContrastToggle) ) + 0.5 );
			float4 temp_cast_25 = (temp_output_353_0_g79).xxxx;
			float div356_g79=256.0/float((int)255.0);
			float4 posterize356_g79 = ( floor( temp_cast_25 * div356_g79 ) / div356_g79 );
			float4 temp_cast_26 = (temp_output_353_0_g79).xxxx;
			float4 ifLocalVar360_g79 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar360_g79 = posterize356_g79;
			else
				ifLocalVar360_g79 = temp_cast_26;
			float4 temp_cast_27 = (0.0).xxxx;
			float4 temp_cast_28 = (1.0).xxxx;
			float4 clampResult363_g79 = clamp( ifLocalVar360_g79 , temp_cast_27 , temp_cast_28 );
			float4 lerpResult368_g79 = lerp( lerp(_Shadow2Color,( saturate( min( blendOpSrc365_g79 , blendOpDest365_g79 ) )),_ShadowColorDarken) , lerpResult366_g79 , clampResult363_g79);
			float2 uv_ShadowMask369_g79 = i.uv_texcoord;
			float4 lerpResult372_g79 = lerp( float4( 1,1,1,1 ) , lerpResult368_g79 , tex2D( _ShadowMask, uv_ShadowMask369_g79 ));
			float4 Shadow375_g79 = lerp(temp_cast_13,lerpResult372_g79,_HalfLambertToggle);
			...
			float4 lerpResult451_g79 = lerp( saturate( ( ( RimLight233_g79 + Matcap260_g79 + Reflection280_g79 ) * MatcapShadow261_g79 * Lighting201_g79 * Shadow375_g79 ) ) , float4( 0,0,0,0 ) , lerp(float4( 0,0,0,0 ),EmissiveScrollMask508_g79,_ForceEmissiveToggle));
			c.rgb = lerpResult451_g79.rgb;
			c.a = temp_output_84_0_g79.a;
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 temp_output_512_0_g79 = ( lerpResult513_g79 * lerp(_ScanLineColor,lerpResult578_g79,_ScanLineColor2Toggle) );
			float4 ScanLineEmission534_g79 = lerp(float4( 0,0,0,0 ),temp_output_512_0_g79,_ScanLineToggle);
			...
			float4 EmissiveScroll507_g79 = saturate( lerp(( lerpResult468_g79 * _EmissiveScrollColor ),lerpResult504_g79,_EmissiveScrollGradient) );
			...
			o.Emission = ( ScanLineEmission534_g79 + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissionColor ) + lerp(float4( 0,0,0,0 ),EmissiveScroll507_g79,_EmissiveScrollToggle) + lerpResult588_g79 ).rgb;
		}
...
/*ASEBEGIN
Version=15900
702;92;1218;936;1323.329;870.8154;1.700872;True;False
Node;AmplifyShaderEditor.FunctionNode;161;-612.7683,171.738;Float;False;Reflex Shader Function;0;;79;f5d8f584674c8984ab029c8868eb5bf3;0;0;6;COLOR;186;FLOAT;265;COLOR;0;COLOR;402;FLOAT;403;COLOR;404
Node;AmplifyShaderEditor.CommentaryNode;46;-680.2408,-248.8545;Float;False;591.991;343.938;Properties;4;159;48;136;47;Miscellaneous;0.5514706,0.5514706,0.5514706,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;47;-640.5499,-89.4776;Float;False;Property;_CutoutThreshold;Cutout Threshold;88;0;Create;True;0;0;True;0;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-642.2408,-176.8546;Float;False;Property;_CullMode;Cull Mode;87;1;[Enum];Create;True;0;1;UnityEngine.Rendering.CullMode;True;0;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OutlineNode;31;-300.7683,301.7381;Float;False;0;True;Transparent;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;136;-633.3272,0.9266658;Float;False;Property;_ZWriteMode;Z Write Mode;89;1;[Enum];Create;True;2;On;1;Off;0;0;True;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;159;-320.2441,-64.60989;Float;False;Property;_Unlit;Unlit;90;0;Create;True;0;0;True;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;158,-12;Float;False;True;2;Float;;0;0;CustomLighting;Reflex Shader 2/Reflex Shader 2 Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;Back;0;True;136;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Transparent;;Transparent;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;1;5;False;-1;7;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;True;47;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;31;0;161;402
WireConnection;31;2;161;403
WireConnection;31;1;161;404
WireConnection;0;2;161;186
WireConnection;0;9;161;265
WireConnection;0;13;161;0
WireConnection;0;11;31;0
ASEEND*/
//CHKSM=EC1A0FAE6F6731A5B00266DDB0DD280C21895A97