	...
	SubShader
	{
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float3 hsvTorgb603_g79 = HSVToRGB( float3(( hsvTorgb595_g79.x + _H ),( hsvTorgb595_g79.y + _S ),( hsvTorgb595_g79.z + _V )) );
				...
				float4 staticSwitch604_g79 = float4( hsvTorgb603_g79 , 0.0 );
			#else
				float4 staticSwitch604_g79 = DiffuseBase606_g79;
			#endif
			float4 Diffuse105_g79 = staticSwitch604_g79;
			...
			float4 lerpResult372_g79 = lerp( float4( 1,1,1,1 ) , lerpResult368_g79 , tex2D( _ShadowMask, uv_ShadowMask369_g79 ));
				...
				float4 staticSwitch540_g79 = lerpResult372_g79;
			#else
				float4 staticSwitch540_g79 = temp_cast_8;
			#endif
			float4 Shadow375_g79 = staticSwitch540_g79;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult230_g79 = lerp( ( ( ( ( ( abs( ( 1.0 - dotResult214_g79 ) ) * _RimLightPower ) - 0.5 ) * _RimLightContrast ) + 0.5 ) * ( _RimLightColor * tex2D( _RimLightColorSampler, uv_RimLightColorSampler ) ) ) , float4( 0,0,0,0 ) , ( 1.0 - tex2D( _RimLightMask, uv_RimLightMask225_g79 ) ));
				...
				float4 staticSwitch552_g79 = lerpResult230_g79;
			#else
				float4 staticSwitch552_g79 = float4( 0,0,0,0 );
			#endif
			float4 RimLight233_g79 = saturate( staticSwitch552_g79 );
			float3 NormalMap208_g79 = tex2DNode207_g79;
			...
			float4 lerpResult254_g79 = lerp( float4( 0,0,0,0 ) , ( saturate( ( blendOpSrc251_g79 * blendOpDest251_g79 ) )) , lerp(float4( 1,1,1,1 ),tex2D( _MatcapMask, uv_MatcapMask246_g79 ),_MatcapMaskToggle));
			#ifdef _MATCAPTOGGLE_ON
				float4 staticSwitch553_g79 = lerpResult254_g79;
			#else
				float4 staticSwitch553_g79 = float4( 0,0,0,0 );
			#endif
			float4 DiffuseBase606_g79 = temp_output_84_0_g79;
			float grayscale611_g79 = dot(DiffuseBase606_g79.rgb, float3(0.299,0.587,0.114));
			...
			#endif
			float4 Diffuse105_g79 = staticSwitch604_g79;
			float4 lerpResult252_g79 = lerp( Diffuse105_g79 , float4( 0,0,0,0 ) , lerp(float4( 1,1,1,1 ),tex2D( _MatcapMask, uv_MatcapMask246_g79 ),_MatcapMaskToggle));
			float4 Matcap260_g79 = ( staticSwitch553_g79 + lerp(Diffuse105_g79,lerpResult252_g79,_ForceMatcap) );
			...
			float4 lerpResult372_g79 = lerp( float4( 1,1,1,1 ) , lerpResult368_g79 , tex2D( _ShadowMask, uv_ShadowMask369_g79 ));
				...
				float4 staticSwitch540_g79 = lerpResult372_g79;
			#else
				float4 staticSwitch540_g79 = temp_cast_13;
			#endif
			float4 Shadow375_g79 = staticSwitch540_g79;
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 lerpResult578_g79 = lerp( _ScanLineColor , _ScanLineColor2 , sin( mulTime583_g79 ));
				...
				float4 staticSwitch551_g79 = ( lerpResult513_g79 * lerp(_ScanLineColor,lerpResult578_g79,_ScanLineColor2Toggle) );
			#else
				float4 staticSwitch551_g79 = float4( 0,0,0,0 );
			#endif
			float4 ScanLineEmission534_g79 = staticSwitch551_g79;
...
/*ASEBEGIN
Version=15900
13;20;1906;1014;1026.188;565.6903;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;236;-617.6109,124.1579;Float;False;Reflex Shader Function;0;;79;f5d8f584674c8984ab029c8868eb5bf3;0;0;6;COLOR;186;FLOAT;265;COLOR;0;COLOR;402;FLOAT;403;COLOR;404
...
Node;AmplifyShaderEditor.RangedFloatNode;48;97.2817,-257.6262;Float;False;Property;_CullMode;Cull Mode;85;1;[Enum];Create;True;0;1;UnityEngine.Rendering.CullMode;True;0;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;150,-18;Float;False;True;2;Float;;0;0;CustomLighting;Reflex Shader 2/Stencil/Reader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;1;False;TransparentCutout;;AlphaTest;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;True;2;True;218;255;False;219;255;False;220;6;False;221;1;False;222;0;False;223;0;False;224;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;False;-1;10;False;-1;0;1;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;83;-1;-1;-1;0;False;0;0;False;48;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=448E31F40ECD2E668BCE74EADC112D1C32E7F88A