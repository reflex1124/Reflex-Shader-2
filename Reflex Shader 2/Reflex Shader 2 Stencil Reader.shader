...
Shader "Reflex Shader 2/Stencil/Reader"
{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv_OutlineMask389_g81 = v.texcoord;
			float outlineVar = ( (0.0 + (_OutlineWidth - 0.0) * (0.002 - 0.0) / (1.0 - 0.0)) * tex2Dlod( _OutlineMask, float4( uv_OutlineMask389_g81, 0, 0.0) ) ).r;
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_cast_1 = (grayscale611_g81).xxxx;
			float3 hsvTorgb595_g81 = RGBToHSV( lerp(DiffuseBase606_g81,temp_cast_1,_GrayscaleColor).rgb );
			float3 hsvTorgb603_g81 = HSVToRGB( float3(( hsvTorgb595_g81.x + _H ),( hsvTorgb595_g81.y + _S ),( hsvTorgb595_g81.z + _V )) );
			float4 Diffuse105_g81 = lerp(DiffuseBase606_g81,float4( hsvTorgb603_g81 , 0.0 ),_ColorShift);
			float3 appendResult387_g81 = (float3(_OutlineColor.r , _OutlineColor.g , _OutlineColor.b));
			...
			if( _WorldSpaceLightPos0.w <= 0.0 )
				...
				ifLocalVar196_g81 = ( 1 * ase_lightColor );
			float4 temp_cast_6 = (_AmbientMinimum).xxxx;
			float4 clampResult650_g81 = clamp( ( float4( localFunction_ShadeSH9411_g81 , 0.0 ) + ifLocalVar196_g81 ) , temp_cast_6 , float4( 1,1,1,0 ) );
			float4 temp_cast_7 = (1.0).xxxx;
			#ifdef _UNLIT_ON
				float4 staticSwitch647_g81 = temp_cast_7;
			#else
				float4 staticSwitch647_g81 = saturate( clampResult650_g81 );
			#endif
			float4 Lighting201_g81 = staticSwitch647_g81;
			...
			float4 transform434_g81 = mul(unity_ObjectToWorld,float4( _VDirLight , 0.0 ));
			float dotResult441_g81 = dot( transform434_g81 , float4( newWorldNormal334_g81 , 0.0 ) );
			...
			if( ase_lightColor.a <= 0.0 )
				...
				ifLocalVar431_g81 = lerp(lerp(temp_output_335_0_g81,saturate( ( temp_output_335_0_g81 * 1 ) ),_ObjectShadow),( ( saturate( 	max( blendOpSrc566_g81, blendOpDest566_g81 ) )) * lerp(temp_output_335_0_g81,saturate( ( temp_output_335_0_g81 * 1 ) ),_ObjectShadow) ),_LightIntensityShadowPos);
			...
			#ifdef _UNLIT_ON
				float staticSwitch645_g81 = FixedShadow627_g81;
			#else
				float staticSwitch645_g81 = ifLocalVar431_g81;
			#endif
			float temp_output_351_0_g81 = ( ( ( ( _Shadow1Place + staticSwitch645_g81 ) - 0.5 ) * _Shadow1Contrast ) + 0.5 );
			float4 temp_cast_15 = (temp_output_351_0_g81).xxxx;
			float div354_g81=256.0/float((int)255.0);
			float4 posterize354_g81 = ( floor( temp_cast_15 * div354_g81 ) / div354_g81 );
			float4 temp_cast_16 = (temp_output_351_0_g81).xxxx;
			float4 ifLocalVar358_g81 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar358_g81 = posterize354_g81;
			else
				ifLocalVar358_g81 = temp_cast_16;
			float4 temp_cast_17 = (0.0).xxxx;
			float4 temp_cast_18 = (1.0).xxxx;
			float4 clampResult364_g81 = clamp( ifLocalVar358_g81 , temp_cast_17 , temp_cast_18 );
			float4 lerpResult366_g81 = lerp( _Shadow1Color , float4( 1,1,1,0 ) , clampResult364_g81);
			float temp_output_353_0_g81 = ( ( ( ( _Shadow2Place + staticSwitch645_g81 ) - 0.5 ) * lerp(_Shadow1Contrast,_Shadow2Contrast,_Shadow2ContrastToggle) ) + 0.5 );
			float4 temp_cast_20 = (temp_output_353_0_g81).xxxx;
			float div356_g81=256.0/float((int)255.0);
			float4 posterize356_g81 = ( floor( temp_cast_20 * div356_g81 ) / div356_g81 );
			float4 temp_cast_21 = (temp_output_353_0_g81).xxxx;
			float4 ifLocalVar360_g81 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar360_g81 = posterize356_g81;
			else
				ifLocalVar360_g81 = temp_cast_21;
			float4 temp_cast_22 = (0.0).xxxx;
			float4 temp_cast_23 = (1.0).xxxx;
			float4 clampResult363_g81 = clamp( ifLocalVar360_g81 , temp_cast_22 , temp_cast_23 );
			float4 lerpResult368_g81 = lerp( lerp(_Shadow2Color,( saturate( min( blendOpSrc365_g81 , blendOpDest365_g81 ) )),_ShadowColorDarken) , lerpResult366_g81 , clampResult363_g81);
			...
			float4 Shadow375_g81 = lerp(temp_cast_8,lerpResult372_g81,_HalfLambertToggle);
			o.Emission = ( float4( ( (Diffuse105_g81).rgb * appendResult387_g81 ) , 0.0 ) * Lighting201_g81 * Shadow375_g81 ).rgb;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult230_g81 = lerp( ( ( ( ( ( abs( ( 1.0 - dotResult214_g81 ) ) * _RimLightPower ) - 0.5 ) * _RimLightContrast ) + 0.5 ) * ( _RimLightColor * tex2D( _RimLightColorSampler, uv_RimLightColorSampler ) ) ) , float4( 0,0,0,0 ) , ( 1.0 - tex2D( _RimLightMask, uv_RimLightMask225_g81 ) ));
			float4 RimLight233_g81 = saturate( lerp(float4( 0,0,0,0 ),lerpResult230_g81,_RimLightToggle) );
			float3 NormalMap208_g81 = tex2DNode207_g81;
			...
			float2 temp_output_244_0_g81 = ( 0.5 + ( 0.5 * lerp((temp_output_240_0_g81).xy,(BlendNormals( ( worldToViewDir556_g81 * float3(-1,-1,1) ) , temp_output_240_0_g81 )).xy,_MatcapCameraFix) ) );
			...
			float3 hsvTorgb595_g81 = RGBToHSV( lerp(DiffuseBase606_g81,temp_cast_6,_GrayscaleColor).rgb );
			float3 hsvTorgb603_g81 = HSVToRGB( float3(( hsvTorgb595_g81.x + _H ),( hsvTorgb595_g81.y + _S ),( hsvTorgb595_g81.z + _V )) );
			float4 Diffuse105_g81 = lerp(DiffuseBase606_g81,float4( hsvTorgb603_g81 , 0.0 ),_ColorShift);
			float4 lerpResult252_g81 = lerp( Diffuse105_g81 , float4( 0,0,0,0 ) , tex2DNode246_g81);
			float4 Matcap260_g81 = ( lerp(float4( 0,0,0,0 ),lerpResult254_g81,_MatcapToggle) + lerp(Diffuse105_g81,lerpResult252_g81,_ForceMatcap) );
			...
			float2 uv_ReflectionMask268_g81 = i.uv_texcoord;
			float4 lerpResult273_g81 = lerp( float4( 0,0,0,0 ) , ( float4( indirectSpecular281_g81 , 0.0 ) * _ReflectionColor ) , tex2D( _ReflectionMask, uv_ReflectionMask268_g81 ));
			float4 lerpResult277_g81 = lerp( float4( 0,0,0,0 ) , lerpResult273_g81 , _ReflectionIntensity);
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float fresnelNdotV275_g81 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode275_g81 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV275_g81, _FresnelPower ) );
			float4 lerpResult278_g81 = lerp( float4( 0,0,0,0 ) , lerpResult277_g81 , lerp(1.0,fresnelNode275_g81,_FresnelToggle));
			#ifdef _REFLECTIONTOGGLE_ON
				float4 staticSwitch549_g81 = lerpResult278_g81;
			#else
				float4 staticSwitch549_g81 = float4( 0,0,0,0 );
			#endif
			float4 Reflection280_g81 = staticSwitch549_g81;
			float4 blendOpSrc259_g81 = lerp(float4( 1,1,1,1 ),tex2D( _MatcapShadow, temp_output_244_0_g81 ),_MatcapShadowToggle);
			...
			float4 clampResult650_g81 = clamp( ( float4( localFunction_ShadeSH9411_g81 , 0.0 ) + ifLocalVar196_g81 ) , temp_cast_11 , float4( 1,1,1,0 ) );
			float4 temp_cast_12 = (1.0).xxxx;
			#ifdef _UNLIT_ON
				float4 staticSwitch647_g81 = temp_cast_12;
			#else
				float4 staticSwitch647_g81 = saturate( clampResult650_g81 );
			#endif
			float4 Lighting201_g81 = staticSwitch647_g81;
			...
			if( ase_lightColor.a <= 0.0 )
				...
				ifLocalVar431_g81 = lerp(lerp(temp_output_335_0_g81,saturate( ( temp_output_335_0_g81 * ase_lightAtten ) ),_ObjectShadow),( ( saturate( 	max( blendOpSrc566_g81, blendOpDest566_g81 ) )) * lerp(temp_output_335_0_g81,saturate( ( temp_output_335_0_g81 * ase_lightAtten ) ),_ObjectShadow) ),_LightIntensityShadowPos);
			float3 VDirLight648_g81 = _VDirLight;
			float4 transform617_g81 = mul(unity_ObjectToWorld,float4( VDirLight648_g81 , 0.0 ));
			float3 lerpResult624_g81 = lerp( float3( 0,0,1 ) , NormalMap208_g81 , _NormalIntensity);
			float dotResult613_g81 = dot( transform617_g81 , float4( (WorldNormalVector( i , lerpResult624_g81 )) , 0.0 ) );
			...
			#endif
			float temp_output_351_0_g81 = ( ( ( ( _Shadow1Place + staticSwitch645_g81 ) - 0.5 ) * _Shadow1Contrast ) + 0.5 );
			float4 temp_cast_20 = (temp_output_351_0_g81).xxxx;
			float div354_g81=256.0/float((int)255.0);
			float4 posterize354_g81 = ( floor( temp_cast_20 * div354_g81 ) / div354_g81 );
			float4 temp_cast_21 = (temp_output_351_0_g81).xxxx;
			float4 ifLocalVar358_g81 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar358_g81 = posterize354_g81;
			else
				ifLocalVar358_g81 = temp_cast_21;
			float4 temp_cast_22 = (0.0).xxxx;
			float4 temp_cast_23 = (1.0).xxxx;
			float4 clampResult364_g81 = clamp( ifLocalVar358_g81 , temp_cast_22 , temp_cast_23 );
			float4 lerpResult366_g81 = lerp( _Shadow1Color , float4( 1,1,1,0 ) , clampResult364_g81);
			float temp_output_353_0_g81 = ( ( ( ( _Shadow2Place + staticSwitch645_g81 ) - 0.5 ) * lerp(_Shadow1Contrast,_Shadow2Contrast,_Shadow2ContrastToggle) ) + 0.5 );
			float4 temp_cast_25 = (temp_output_353_0_g81).xxxx;
			float div356_g81=256.0/float((int)255.0);
			float4 posterize356_g81 = ( floor( temp_cast_25 * div356_g81 ) / div356_g81 );
			float4 temp_cast_26 = (temp_output_353_0_g81).xxxx;
			float4 ifLocalVar360_g81 = 0;
			if( _PosterizeToggle >= 0.5 )
				ifLocalVar360_g81 = posterize356_g81;
			else
				ifLocalVar360_g81 = temp_cast_26;
			float4 temp_cast_27 = (0.0).xxxx;
			float4 temp_cast_28 = (1.0).xxxx;
			float4 clampResult363_g81 = clamp( ifLocalVar360_g81 , temp_cast_27 , temp_cast_28 );
			float4 lerpResult368_g81 = lerp( lerp(_Shadow2Color,( saturate( min( blendOpSrc365_g81 , blendOpDest365_g81 ) )),_ShadowColorDarken) , lerpResult366_g81 , clampResult363_g81);
			float2 uv_ShadowMask369_g81 = i.uv_texcoord;
			float4 lerpResult372_g81 = lerp( float4( 1,1,1,1 ) , lerpResult368_g81 , tex2D( _ShadowMask, uv_ShadowMask369_g81 ));
			float4 Shadow375_g81 = lerp(temp_cast_13,lerpResult372_g81,_HalfLambertToggle);
			...
			float4 lerpResult451_g81 = lerp( saturate( ( ( RimLight233_g81 + Matcap260_g81 + Reflection280_g81 ) * MatcapShadow261_g81 * Lighting201_g81 * Shadow375_g81 ) ) , float4( 0,0,0,0 ) , lerp(float4( 0,0,0,0 ),EmissiveScrollMask508_g81,_ForceEmissiveToggle));
			c.rgb = lerpResult451_g81.rgb;
			c.a = 1;
			clip( temp_output_84_0_g81.a - _Cutoff );
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 temp_output_512_0_g81 = ( lerpResult513_g81 * lerp(_ScanLineColor,lerpResult578_g81,_ScanLineColor2Toggle) );
			float4 ScanLineEmission534_g81 = lerp(float4( 0,0,0,0 ),temp_output_512_0_g81,_ScanLineToggle);
			...
			float4 EmissiveScroll507_g81 = saturate( lerp(( lerpResult468_g81 * _EmissiveScrollColor ),lerpResult504_g81,_EmissiveScrollGradient) );
			...
			o.Emission = ( ScanLineEmission534_g81 + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissionColor ) + lerp(float4( 0,0,0,0 ),EmissiveScroll507_g81,_EmissiveScrollToggle) + lerpResult588_g81 ).rgb;
		}
...
/*ASEBEGIN
Version=15900
702;92;1218;936;770.688;526.6903;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;46;59.28168,-329.6262;Float;False;281.991;261.938;Properties;2;48;235;Miscellaneous;0.5514706,0.5514706,0.5514706,1;0;0
Node;AmplifyShaderEditor.FunctionNode;237;-617.6109,124.1579;Float;False;Reflex Shader Function;0;;81;f5d8f584674c8984ab029c8868eb5bf3;0;0;6;COLOR;186;FLOAT;265;COLOR;0;COLOR;402;FLOAT;403;COLOR;404
Node;AmplifyShaderEditor.RangedFloatNode;219;469.1616,-203.5059;Float;False;Property;_StencilReadMask;Stencil Read Mask;91;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;220;469.1616,-119.5059;Float;False;Property;_StencilWriteMask;Stencil Write Mask;92;0;Create;True;0;0;False;0;255;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;97.2817,-257.6262;Float;False;Property;_CullMode;Cull Mode;89;1;[Enum];Create;True;0;1;UnityEngine.Rendering.CullMode;True;0;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;221;673.1616,-297.5059;Float;False;Property;_StencilComparison;Stencil Comparison;93;0;Create;True;0;0;False;0;255;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;465.1616,-293.5059;Float;False;Property;_StencilReference;Stencil Reference;90;0;Create;True;0;0;True;0;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;224;895.1616,-295.5059;Float;False;Property;_StencilZFailFront;Stencil Z Fail Front;96;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;235;100.3115,-178.6903;Float;False;Property;_Unlit;Unlit;88;0;Create;True;0;0;True;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;223;685.1616,-117.5059;Float;False;Property;_StencilFailFront;Stencil Fail Front;95;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;222;681.1616,-209.5059;Float;False;Property;_StencilPassFront;Stencil Pass Front;94;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;150,-18;Float;False;True;2;Float;;0;0;CustomLighting;Reflex Shader 2/Stencil/Reader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;1;False;TransparentCutout;;AlphaTest;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;True;2;True;218;255;False;219;255;False;220;6;False;221;1;False;222;0;False;223;0;False;224;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;False;-1;10;False;-1;0;1;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;87;-1;-1;-1;0;False;0;0;False;48;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=EA8BD625378FE41A651EF8D967FBCF8104782484